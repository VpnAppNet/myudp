...
menu() {
  ...
  echo "╚══════════════════════════════════════════╝"
  echo -e "${NC}"
  echo -e "${PINK}👉 1. အကောင့်အသစ်ဖွင့်မည်${NC}"
  echo -e "${PINK}👉 2. စကားဝှက် / Expired ပြင်မည်${NC}"
  echo -e "${PINK}👉 3. အကောင့်ဖျက်မည်${NC}"
  echo -e "${PINK}👉 4. အကောင့်စာရင်းကြည့်မည်${NC}"
  echo -e "${PINK}👉 5. ဒိုမိန်းပြန်ပြင်မည်${NC}"
  echo -e "${PINK}👉 6. Obfs ပြင်မည်${NC}"
  echo -e "${PINK}👉 7. Upload Speed ပြင်မည်${NC}"
  echo -e "${PINK}👉 8. Download Speed ပြင်မည်${NC}"
  echo -e "${PINK}👉 9. Online User (Real-Time)${NC}"
  echo -e "${PINK}👉 10. ဆာဗာပြန်စတင်မည်${NC}"
  echo -e "${PINK}👉 11. ဆာဗာဖျက်သိမ်းမည်${NC}"
  echo -e "${PINK}👉 12. ထွက်မည်${NC}"
  echo
  echo -e "${PINK}ရွေးချယ်ပါ ➜ ${NC}"
}
