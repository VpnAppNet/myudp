...
# ================= MENU BOX (PINK, FIXED WIDTH) =================
BOX=44
top()    { printf "${PINK}┌%*s┐${NC}\n" "$((BOX+2))" | tr ' ' '─'; }
bottom() { printf "${PINK}└%*s┘${NC}\n" "$((BOX+2))" | tr ' ' '─'; }
line()   { printf "${PINK}│ ${PINK}%-*s ${PINK}│${NC}\n" "$BOX" "$1"; }
...
menu() {
  top
  line "👉 1. အကောင့်အသစ်ဖွင့်မည်"
  line "👉 2. စကားဝှက် / Expired ပြင်မည်"
  line "👉 3. အကောင့်ဖျက်မည်"
  line "👉 4. အကောင့်စာရင်းကြည့်မည်"
  line "👉 5. ဒိုမိန်းပြန်ပြင်မည်"
  line "👉 6. Obfs ပြင်မည်"
  line "👉 7. Upload Speed ပြင်မည်"
  line "👉 8. Download Speed ပြင်မည်"
  line "👉 9. Online User (Real-Time)"
  line "👉 10. ဆာဗာပြန်စတင်မည်"
  line "👉 11. ဆာဗာဖျက်သိမ်းမည်"
  line "👉 12. ထွက်မည်"
  bottom
